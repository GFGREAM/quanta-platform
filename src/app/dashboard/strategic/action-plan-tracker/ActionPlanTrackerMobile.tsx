...
export default function ActionPlanTrackerMobile() {
  const {
    ...
    setDetailId,
    activeFilterCount,
    displayed, stats, detailAction, clearAll,
  } = useActionPlan();
  const [filtersOpen, setFiltersOpen] = useState(false);

  // Mobile shows every distinct value, not the cross-filtered subset — keeps
  // the bottom-sheet predictable when many filters are stacked on a small screen.
